---
id: opp_aalto-doctoral-researcher-in-simulation-of-variable-speed-el
type: opportunity
title: "Doctoral Researcher in Simulation of Variable Speed Electric Machines with Advanced Magnetic Material"
...
# Doctoral Researcher in Simulation of Variable Speed Electric Machines with Advanced Magnetic Material

**Organisation:** [[org_aalto_university]] (Aalto University)
**Deadline:** 2026-10-01 (12:00 UTC)
**Location:** Espoo, Finland
**Position type:** phd
**Salary:** not stated
**Duration:** not stated
**Status:** open
**Official source:** https://www.aalto.fi/en/open-positions/doctoral-researcher-in-simulation-of-variable-speed-electric-machines-with-advanced-magnetic
...
please submit your application through our recruitment site (”Apply now!” at the bottom of the page) by 1 October 2026
.
...
Doctoral researcher position in computational electromagnetics focused on magnetic material modelling, finite-element simulation, and experimental validation of variable-speed electric machines. Core work spans material characterization, numerical analysis, and machine-level testing in collaboration with ABB.
...
**Risks:**
- Disciplinary mismatch: Position anchors in electrical engineering and physics; researcher's identity is in HCI and design. Unlikely to feel aligned with group culture or research priorities.
- Skill requirements: No experience in FEM, magnetism, materials characterization, or the specific numerical methods central to the role. Steep learning curve on non-target technical areas.
- Career direction: Accepting this role may signal a pivot away from human-centred immersive systems research, potentially weakening future applications to HCI-focused groups.
- No human factors, user studies, or interaction design component.

---
_Generated file — do not edit. Personal notes: create `vault/notes/opp_aalto-doctoral-researcher-in-simulation-of-variable-speed-el.md` and link [[opp_aalto-doctoral-researcher-in-simulation-of-variable-speed-el]]._
