---
id: opp_tudelft-phd-position-future-energy-infrastructure-planning-u
type: opportunity
title: "PhD Position Future Energy Infrastructure Planning Under Uncertainty in collaboration with Stedin"
...
**Duration:** not stated
**Status:** open
**Official source:** https://careers.tudelft.nl/job/Delft-PhD-Position-Future-Energy-Infrastructure-Planning-Under-Uncertainty-in-collaboration-with-Stedin-2628-CD/1371575857/
...
Do you want to develop innovative solutions to support urgent energy infrastructure planning challenges?
...
If you would like more information about this vacancy or the selection procedure, please contact Francesco Lombardi, via
...
PhD position in energy infrastructure planning under uncertainty, focusing on grid operator decision-making for carbon-neutral energy systems. Combines energy system modelling, optimization under uncertainty (MGA), and stakeholder engagement with a Dutch distribution grid operator (Stedin).
...
**Risks:**
- Complete domain mismatch: energy infrastructure planning has no connection to XR, HCI, or spatial cognition research.
- Researcher would need to acquire substantial new domain knowledge (energy systems, optimization, grid operations) with no foundation.
- Position would delay or derail the researcher's trajectory toward human-centred XR research.

---
_Generated file — do not edit. Personal notes: create `vault/notes/opp_tudelft-phd-position-future-energy-infrastructure-planning-u.md` and link [[opp_tudelft-phd-position-future-energy-infrastructure-planning-u]]._
