---
id: opp_tudelft-postdoc-in-ev-charging-second-life-battery-for-urban
type: opportunity
title: "Postdoc in EV Charging & Second Life Battery for Urban DC Traction Grids"
...
**Duration:** not stated
**Status:** open
**Official source:** https://careers.tudelft.nl/job/Delft-Postdoc-in-EV-Charging-&-Second-Life-Battery-for-Urban-DC-Traction-Grids-2628-CD/1371934157/
...
We offer a pleasant working environment with a dynamic and highly knowledgable team. For more information about this vacancy,  please contact Dr. Gautham Ram at G.R.ChandraMouli@tudelft.nl
For information about the selection procedure, please contact Sharmila Rattansingh, Management assistant at s.rattansingh@tudelft.nl.
Application procedure
Are you interested in this vacancy? Please submit:
Motivation letter addressed that explains your personal motivation in pursuing the Postdoc in general, and this topic in specific. Lay emphasis on how your background (PhD research, work experinence, etc) is an excellent fit to the job requirements. Please do not use Large Language Models (like ChatGPT) for providing a standard/non-personalized letter.
Your CV
List of 5 of your publications that you deem most fitting to the Postdoc position
A list of grades of your qualifying degrees (such as BSc, MSc)
You can address your application to dr. Gautham Ram.
Incomplete applications will not be considered.
The deadline for applications is 6 Octoer 2026 at 23:59 CET.
Please note that applications will be assessed on a rolling basis and suitable candidates will be invited for interview, so it is recommended not to wait until the deadline with your application. A knowledge security screening may be performed.
Please note:
You can apply online. We will not process applications sent by email and/or post.
Applications will be assessed on a rolling basis and suitable candidates will be invited for interview, so it is recommended not to wait until the deadline with your application.
...
#EUfunded This is an EU funded project, named GRID4CITY, within the Driving Urban Transitions (DUT) Partnerships program call 2025-26.

## AI analysis

_claude-haiku-4-5-20251001 · fit_analysis_v1 · confidence 0.98_

Postdoc in battery diagnostics, second-life energy storage, and EV charging systems using digital twins. Research spans battery degradation, state-of-health estimation, and traction-grid integration with focus on technical/energetic systems. EU-funded GRID4CITY project.
...
**Risks:**
- Eligibility blocker: position requires completed PhD; researcher does not hold one.
- Severe domain divergence. Accepting would stall progress toward human-centred XR research.
- No supervisory support for XR or HCI methodologies in this group.

---
_Generated file — do not edit. Personal notes: create `vault/notes/opp_tudelft-postdoc-in-ev-charging-second-life-battery-for-urban.md` and link [[opp_tudelft-postdoc-in-ev-charging-second-life-battery-for-urban]]._
