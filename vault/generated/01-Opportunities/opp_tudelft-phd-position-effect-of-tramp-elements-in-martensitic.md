---
id: opp_tudelft-phd-position-effect-of-tramp-elements-in-martensitic
type: opportunity
title: "PhD Position Effect of Tramp Elements in Martensitic Stainless Steels"
...
**Duration:** not stated
**Status:** open
**Official source:** https://careers.tudelft.nl/job/Delft-PhD-Position-Effect-of-Tramp-Elements-in-Martensitic-Stainless-Steels-2628-CD/1367398257/
...
For more information about this vacancy, please contact Prof. Dr. Maria J. Santofimia (
M.J.SantofimiaNavarro@tudelft.nl
).
For information about the application procedure, please contact Mrs. Anita van Vianen, email:
...
You can address your application to Prof. Dr. Maria J. Santofimia.
...
PhD position investigating how tramp elements (impurity residuals from recycled scrap) affect martensitic stainless steel microstructure, processing, and properties. Combines materials characterization, metallurgical analysis, and microstructure evolution study with industrial sustainability focus.
...
**Risks:**
- Fundamental domain mismatch: materials science/metallurgy vs. human-centred HCI research
- Career redirect away from target identity and research community
- No existing supervisor relationship or recommendation in materials science
- Steep learning curve in unfamiliar materials characterization methods; weak positioning in cohort of materials-trained peers
- Industrial focus on steel recycling unrelated to researcher's interests in learning and spatial cognition

---
_Generated file — do not edit. Personal notes: create `vault/notes/opp_tudelft-phd-position-effect-of-tramp-elements-in-martensitic.md` and link [[opp_tudelft-phd-position-effect-of-tramp-elements-in-martensitic]]._
