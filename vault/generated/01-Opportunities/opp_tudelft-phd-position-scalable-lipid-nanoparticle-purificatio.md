---
id: opp_tudelft-phd-position-scalable-lipid-nanoparticle-purificatio
type: opportunity
title: "PhD Position Scalable Lipid Nanoparticle Purification Technologies"
...
**Duration:** not stated
**Status:** open
**Official source:** https://careers.tudelft.nl/job/Delft-PhD-Position-Scalable-Lipid-Nanoparticle-Purification-Technologies-2628-CD/1371554657/
...
If you would like more information about this vacancy or the selection procedure, please contact Dr. Alina Rwei, via
a.y.rwei@tudelft.nl
.
...
If the applicants are selected for an interview, they will be asked to provide contact details of three referees with their consent.
...
This PhD concerns purification technologies for lipid nanoparticles used in pharmaceutical manufacturing. The research combines computational flow modelling with laboratory verification of membranes and filtration-system designs, with no connection to XR, HCI, learning or spatial interaction.
...
**Risks:**
- Strong disciplinary mismatch with the candidate's research identity
- Core computational fluid-dynamics and pharmaceutical process requirements are not evidenced
- The project would likely require substantial retraining without producing target-relevant research outputs

---
_Generated file — do not edit. Personal notes: create `vault/notes/opp_tudelft-phd-position-scalable-lipid-nanoparticle-purificatio.md` and link [[opp_tudelft-phd-position-scalable-lipid-nanoparticle-purificatio]]._
