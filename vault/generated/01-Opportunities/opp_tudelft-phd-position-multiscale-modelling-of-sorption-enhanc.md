---
id: opp_tudelft-phd-position-multiscale-modelling-of-sorption-enhanc
type: opportunity
title: "PhD Position Multiscale Modelling of Sorption-Enhanced CO2 Hydrogenation Reactors"
...
**Duration:** not stated
**Status:** open
**Official source:** https://careers.tudelft.nl/job/Delft-PhD-Position-Multiscale-Modelling-of-Sorption-Enhanced-CO2-Hydrogenation-Reactors-2628-CD/1370698657/
...
Doctoral position in multiphase CFD modelling for sorption-enhanced CO2 hydrogenation reactors, including hydrodynamics, heat/mass transfer, and reactor design via coarse-grained CFD-DEM or Eulerian approaches.
...
**Risks:**
- Core exclusion criterion triggered: position is pure CFD/computational engineering, not HCI or immersive systems
- Disciplinary mismatch: Engineering reactor modelling vs. multimedia/HCI research background
- No research infrastructure or knowledge transfer from researcher's XR/immersive systems background
- Would require complete reorientation into numerical methods and engineering; not adjacent methodological fit

---
_Generated file — do not edit. Personal notes: create `vault/notes/opp_tudelft-phd-position-multiscale-modelling-of-sorption-enhanc.md` and link [[opp_tudelft-phd-position-multiscale-modelling-of-sorption-enhanc]]._
