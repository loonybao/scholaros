---
id: opp_tudelft-two-phd-positions-in-user-centred-design-of-public-t
type: opportunity
title: "Two PhD positions in User-centred Design of Public Transport"
...
**Duration:** not stated
**Status:** open
**Official source:** https://careers.tudelft.nl/job/Delft-Two-PhD-positions-in-User-centred-Design-of-Public-Transport-2628-CD/1365906357/

## Eligibility

Gate: **pass** (days to deadline: 30)


## Description

Design effortless public transport solutions in a trans-disciplinary environment, collaborating with multiple stakeholders from academia, government and industry.
Job description
...
If you would like more information about this vacancy or the selection procedure, please contact Suzanne Hiemstra-van Mastrigt (
S.Hiemstra-vanMastrigt@tudelft.nl
)
For information about the application procedure, please contact Hanneke Sosef-de Haan (
h.sosef-dehaan@tudelft.nl
)
Application procedure
Are you interested in this position? Please apply no later than
August 17, 2026
...
Two fully funded 4-year PhDs in the 'Effortless public transport' project across IDE/CEG/TPM faculties with Dutch transport authorities (DOVA): user studies of travel barriers, user-centred interventions, participatory design, field experiments; 1-2 days/week at the DOVA office in Utrecht.
...
**Risks:**
- Language requirement likely decisive regardless of fit
- Would move the research identity toward service design and away from XR

---
_Generated file — do not edit. Personal notes: create `vault/notes/opp_tudelft-two-phd-positions-in-user-centred-design-of-public-t.md` and link [[opp_tudelft-two-phd-positions-in-user-centred-design-of-public-t]]._
