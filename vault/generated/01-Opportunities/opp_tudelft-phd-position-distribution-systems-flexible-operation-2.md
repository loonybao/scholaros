---
id: opp_tudelft-phd-position-distribution-systems-flexible-operation-2
type: opportunity
title: "PhD Position Distribution Systems Flexible Operation under Uncertain and Incomplete Information"
...
**Duration:** not stated
**Status:** open
**Official source:** https://careers.tudelft.nl/job/Delft-PhD-Position-Distribution-Systems-Flexible-Operation-under-Uncertain-and-Incomplete-Information-2628-CD/1371867757/
...
You can address your application to Pedro P. Vergara, Associate Professor. We encourage you to apply at your earliest convenience, as applications will be reviewed on a rolling basis. We will also begin conducting initial exploratory interviews during the application period.
...
Doctoral researcher position (4 years) in AI/ML methods for distribution system operation under uncertainty and limited data. Research addresses flexibility coordination in low-voltage grids with distributed energy resources and smart buildings.
...
**Risks:**
- Position core is pure ML algorithm development and optimization methods for energy systems, explicitly listed as poor-fit category
- Research agenda (AI/ML models, surrogate models, optimization packages) emphasizes algorithmic innovation, not user-facing system design
- Supervisor research group focuses on power systems and control, not human-centred research
- No immersive systems, learning science, or HCI methodology present

---
_Generated file — do not edit. Personal notes: create `vault/notes/opp_tudelft-phd-position-distribution-systems-flexible-operation-2.md` and link [[opp_tudelft-phd-position-distribution-systems-flexible-operation-2]]._
