---
id: opp_tampere-postdoctoral-research-fellow-gamification-games-xr-g
type: opportunity
...
**Duration:** not stated
**Status:** open
**Official source:** https://tuni.rekrytointi.com/paikat/?o=A_RJ&jgid=3&jid=3170
...
.
We are seeking postdoctoral research fellows in the area of gameful and engaging technologies for sustainability to join us at the
...
The selected postdoctoral research fellow(s) will develop their own research plans within this broader research agenda. Some of the positions are expected to be connected to the project CLIMETA, while others may be shaped around the OPEN theme relating to the above-described emerging research directions within the Research Centre of Gameful Realities (see Research Context below).
We therefore welcome: a)
applicants with a clear interest in
CLIMETA
, as well as
b)
applicants whose proposed research fits the wider theme of engaging media and technologies for sustainable applications (
OPEN
).
...
Within CLIMETA, possible postdoctoral research themes may include, for example, VR-based climate engagement, metacognitive reflection, avatar embodiment and perspective-taking, AI-supported reflective agents, bioadaptive interactions, and developing methods for assessing meta-engagement in immersive environments.
JOB DESCRIPTION
In this position, we invite candidates to propose their own research agenda relating to engaging media and technologies by drawing on methodologies such as design and participatory design workshops, VR development, LLM conversational agent design and/or evaluation methodologies, and laboratory experiments including interviews and psychophysiological measurements. We especially welcome applicants interested in laboratory and experimental research, while also valuing interdisciplinary and design-oriented approaches. The postdoctoral research fellow(s) selected for this position will develop their own research agenda within the broader scope of the open positions.
...
Strong academic writing skills and publication productivity
...
A typical starting salary for a Postdoctoral Researcher with no or little prior experience is approximately €4,000 per month.
The salary increases based on the job requirement level and personal performance level.
...
.
WORKING ENVIRONMENT
Depending on their topic, selected research fellow(s) will be based at Tampere University’s City centre campus within the Computing Sciences Unit at the Faculty of Information Technology and Communication Sciences (ITC) (CLIMETA and OPEN themes), or at the Hervanta campus within the Faculty of Management and Business (OPEN themes). They will work in close collaboration with researchers across the Research Centre of Gameful Realities (RCGR) in the context of the larger strategic profiling area of Tampere University in Gamification, Extended Reality and their application towards holistic sustainability.
...
:
CV
List of publications, with the most important publications clearly marked (maximum 5)
A motivation letter (max 2 pages) that briefly outlines:
Page 1
: Motivation to apply including how this position would support your career development, earliest starting date, and any other miscellaneous remarks that the candidate wishes to make. Please clearly specify which of the positions listed above you are applying for.
Page 2
...
.
Tampereen yliopistossa on haettavana Tutkijatohtorin (Gamification / Games / XR / GenAI / Emerging Media for Engagement with Sustainable Futures) tehtävät (1-3 tehtävää).
HAKUOHJEET
