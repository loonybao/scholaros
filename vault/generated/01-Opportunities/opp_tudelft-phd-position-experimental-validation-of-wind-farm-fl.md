---
id: opp_tudelft-phd-position-experimental-validation-of-wind-farm-fl
type: opportunity
title: "PhD Position Experimental Validation of Wind Farm Flow Control"
...
**Duration:** not stated
**Status:** open
**Official source:** https://careers.tudelft.nl/job/Delft-PhD-Position-Experimental-Validation-of-Wind-Farm-Flow-Control-2628-CD/1372817157/
...
4-year doctoral position at TU Delft, Delft Center for Systems and Control (Faculty of Mechanical Engineering), focused on experimental validation and data-fusion methods for wind farm flow control and wake-mixing strategies. Role bridges aerodynamics, control, system identification, and data-driven modelling with emphasis on combining physical models with experimental data.
...
**Missing skills:** fluid-dynamics, wind-energy, aerodynamics, systems-control, matlab, data-fusion, experimental-testing

**Risks:**
- Severe disciplinary mismatch: wind energy and fluid dynamics vs. HCI and immersive systems. Researcher has no aerospace, aerodynamics, wind energy, or advanced control background.
- Master's degree field (Creative Multimedia) falls well outside specified discipline list (Systems & Control, Engineering, Math). High likelihood of application screening rejection based on qualifications.
- Experimental work is wind-tunnel and field testing (offshore installations), not user research; incompatible skill set.
- 4-year commitment to wind energy research would delay entry into target immersive systems domain and fragment research identity.
- Supervisor and group are wind energy specialists; no mentorship in HCI, spatial cognition, or immersive systems design.
- Teaching activities in energy engineering and control would reinforce disciplinary drift away from HCI.

---
_Generated file — do not edit. Personal notes: create `vault/notes/opp_tudelft-phd-position-experimental-validation-of-wind-farm-fl.md` and link [[opp_tudelft-phd-position-experimental-validation-of-wind-farm-fl]]._
