---
id: opp_tudelft-phd-position-molecular-dynamics-simulations-of-lipid
type: opportunity
title: "PhD Position Molecular Dynamics Simulations of Lipid Nanoparticle Formation and Purification"
...
**Duration:** not stated
**Status:** open
**Official source:** https://careers.tudelft.nl/job/Delft-PhD-Position-Molecular-Dynamics-Simulations-of-Lipid-Nanoparticle-Formation-and-Purification-2628-CD/1369984057/
...
PhD position in molecular dynamics simulations of lipid nanoparticle (LNP) formation and purification for nanomedicine manufacturing, embedded in the SPARC cancer research program. Joint position between Complex Fluid Processing and Precision Therapeutics groups with pharmaceutical industry partnerships (Merck, J&J).
...
**Missing skills:** molecular-dynamics-simulations, computational-chemistry, transport-phenomena, cfd-simulation, coarse-grained-modeling, chemical-engineering-fundamentals, pharmaceutical-process-knowledge

**Risks:**
- Severe skill gap: candidate lists Python as beginner with no project experience; position requires coarse-grained MD simulations and CFD implementation.
- Disciplinary mismatch: candidate's background is creative multimedia and HCI; pharmaceutical nanotechnology and chemical engineering require fundamentals not present.
- Research identity conflict: this position would push candidate away from human-centred XR and into pure computational chemistry—opposite of target identity.
- Supervisor misalignment: Prof. Johan Padding and Dr. Alina Rwei work on drug delivery systems and complex fluids, not immersive systems or human-centred research.
- No path to target institution/position type: this specialization does not lead to human-centred XR roles at priority-1 institutions.

---
_Generated file — do not edit. Personal notes: create `vault/notes/opp_tudelft-phd-position-molecular-dynamics-simulations-of-lipid.md` and link [[opp_tudelft-phd-position-molecular-dynamics-simulations-of-lipid]]._
