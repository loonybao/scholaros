---
id: opp_tudelft-phd-position-advancing-electrically-driven-separatio
type: opportunity
title: "PhD Position Advancing Electrically Driven Separation Processes via Local pH-Gradient Analysis"
...
**Duration:** not stated
**Status:** open
**Official source:** https://careers.tudelft.nl/job/Delft-PhD-Position-Advancing-Electrically-Driven-Separation-Processes-via-Local-pH-Gradient-Analysis-2628-CD/1372913757/
...
You will join the interdisciplinary research team of the Bazyar Lab within the Department of Chemical Engineering, section of Catalysis, Separation, and Electrochemical engineering (CaSE), working under the supervision of
Dr. Hanieh Bazyar
. As part of this project, you will collaborate closely with
Dr. Jouke Dykstra
at Wageningen University and with industrial partners from the Dutch food, paper, and chemical sectors.
...
In case you have a question about the procedure, please contact Els Arkesteijn (Secr-CaSE-TNW@tudelft.nl), management assistant of the CaSE section
...
TU Delft is recruiting a PhD candidate to investigate electrically-induced pH gradients in membrane separation processes using fluorescence lifetime imaging microscopy (FLIM) and computational modeling. Work involves electrochemistry, materials characterization, and industrial wastewater treatment—core expertise in chemical engineering and electrochemistry, not immersive systems.
...
**Missing skills:** electrochemical-systems, fluorescence-lifetime-imaging-microscopy, membrane-characterization, transport-phenomena, computational-modeling-transport, chemical-engineering, advanced-statistics

**Risks:**
- Fundamental domain mismatch: this is applied chemistry and materials engineering, entirely outside the researcher's expertise and target career path.
- Eligibility barrier: MSc background in Creative Multimedia does not match stated requirements. Application may be rejected at screening.
- Skills gap is profound: FLIM microscopy, electrochemistry, transport phenomena, and process engineering are specialized disciplines requiring foundational training the researcher lacks.
- Opportunity cost: A 4-year PhD in electrochemistry would exclude the researcher from immersive systems research and make subsequent XR positions less competitive.
- Weak supervisory fit: Dr. Bazyar's group is not positioned to mentor an HCI researcher repurposing into electrochemistry.
- Geographic and institutional match (Netherlands, TU Delft) cannot overcome thematic and eligibility misalignment.

---
_Generated file — do not edit. Personal notes: create `vault/notes/opp_tudelft-phd-position-advancing-electrically-driven-separatio.md` and link [[opp_tudelft-phd-position-advancing-electrically-driven-separatio]]._
