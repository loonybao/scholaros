---
id: opp_tudelft-postdoc-measuring-and-simulating-low-clouds
type: opportunity
title: "Postdoc Measuring and Simulating Low Clouds"
...
**Duration:** not stated
**Status:** open
**Official source:** https://careers.tudelft.nl/job/Delft-Postdoc-Measuring-and-Simulating-Low-Clouds-2628-CD/1371863457/
...
Postdoc in ERC Synergy Project (TurPhyCloud) studying stratocumulus cloud microphysics, turbulence, and radiation using in-situ drone/helikite measurements and LES/CFD simulations. Requires CFD, programming (Python/Fortran/C++), and atmospheric science background.
...
- Severe domain mismatch. Atmospheric/cloud physics research unrelated to human-centred immersive systems.
- Researcher lacks CFD and atmospheric-science expertise; would require extensive retraining.
- Prestigious funding and international team are valuable, but group is outside HCI/XR research. Would not advance toward target identity.

---
_Generated file — do not edit. Personal notes: create `vault/notes/opp_tudelft-postdoc-measuring-and-simulating-low-clouds.md` and link [[opp_tudelft-postdoc-measuring-and-simulating-low-clouds]]._
