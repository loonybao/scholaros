---
id: opp_tudelft-postdoc-molecular-dynamics-and-process-simulation-of
type: opportunity
title: "Postdoc Molecular Dynamics and Process Simulation of High Temperature Thermal Storage Systems"
...
**Salary:** €4728 - €6433 per month (stated range)
**Duration:** not stated
**Status:** open
**Official source:** https://careers.tudelft.nl/job/Delft-Postdoc-Molecular-Dynamics-and-Process-Simulation-of-High-Temperature-Thermal-Storage-Systems-2628-CD/1363888557/
...
For more information about this vacancy, please contact Prof. Kamel Hooman via
k.hooman@tudelft.nl
.
...
CV
Motivational letter
You can address your application to Prof. Kamel Hooman.
Please note:
...
Postdoctoral position in multiscale modelling of molten salts for high-temperature thermal energy storage, combining molecular dynamics and process-scale simulations. Part of an industrial decarbonization project (HyCarb) at TU Delft's Mechanical Engineering faculty.
...
**Missing skills:** molecular-dynamics, process-simulation, thermodynamics, heat-transfer, computational-chemistry

**Risks:**
- Career trajectory mismatch: postdoc in chemistry/materials science diverges substantially from stated target (human-centred XR researcher) and makes return to HCI community more difficult
- Skill floor very high; researcher would begin with foundational gaps in thermodynamics, molecular simulation software, and computational chemistry
- No direct methodological transfer; HCI experimental design does not map to MD/process simulation workflows
- Industrial context (decarbonization, molten salts) is orthogonal to research identity; limited publication overlap with target community

---
_Generated file — do not edit. Personal notes: create `vault/notes/opp_tudelft-postdoc-molecular-dynamics-and-process-simulation-of.md` and link [[opp_tudelft-postdoc-molecular-dynamics-and-process-simulation-of]]._
