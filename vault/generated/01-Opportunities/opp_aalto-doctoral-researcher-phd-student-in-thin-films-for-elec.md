---
id: opp_aalto-doctoral-researcher-phd-student-in-thin-films-for-elec
type: opportunity
title: "Doctoral researcher (PhD student) in thin films for electrocatalysis"
...
# Doctoral researcher (PhD student) in thin films for electrocatalysis
...
**Duration:** not stated
**Status:** open
**Official source:** https://www.aalto.fi/en/open-positions/doctoral-researcher-phd-student-in-thin-films-for-electrocatalysis
...
Deposition of promising HER and OER electrocatalyst materials by ALD using established chemistries where available and development of new processes when needed
Characterization of the deposited films in terms of composition, crystallinity, morphology… using a range of spectroscopic, microscopic, X-ray etc. techniques
Electrochemical testing under HER and OER conditions and development of test protocols
Dissemination of research findings through scientific publications and conference presentations
Depending on your interests, you may also dive deeper into the structure of the electrocatalysts during operation (
operando)
or perform laboratory-scale electrolyzer testing, for example.
...
group, working with a postdoctoral researcher to be recruited for the ThinCat project and researchers to be recruited for European Research Council’s Starting Grant project that uses ALD to engineer enhanced PEM electrolyzers as well as other future team members.
...
A Master’s degree in Chemistry, Materials Science, (Materials) Physics, or a related field
...
Hands-on expertise in one or more of the following skills is considered advantageous: atomic layer deposition, other thin film deposition techniques, electrocatalysis, electrochemistry, thin film characterization techniques.
Applicants must fulfill the eligibility and admission criteria for
Aalto Doctoral Programme in Chemical Engineering
. Doctoral studies at Aalto University take approximately four years.
What we offer
...
We offer a fixed term contract initially for 2 years. During the first 6 months you must apply and receive a right to study in the Doctoral Programme in Chemical Engineering. After a successful evaluation by the end of the first 2 year contract, the contract can be extended. Extension contract is typically based on the progress evaluation, revised project plan and available funding.
The starting salary for a Doctoral Researcher is 3142,65 €/month (gross). The contract includes Aalto University occupational healthcare benefits.
The preferred starting date is
October-December 2026
with exact date to be agreed with the selected candidate.
...
Join us!
To apply, please submit your application including your
CV
and
motivation letter
through our recruitment site (click "Apply now!”) latest at 23.59pm (EET)
11th October 2026
.
...
Note that only submissions through the online recruitment system are accepted. Applications sent via email or other means will not be considered.
...
Doctoral position in materials chemistry focused on thin-film electrocatalyst synthesis and characterization for water electrolysis using atomic layer deposition and electrochemical testing.
...
**Missing skills:** atomic-layer-deposition, electrocatalysis, electrochemistry, thin-film-characterization

**Risks:**
- Fundamental domain mismatch: materials chemistry has no research continuity with human-centred XR or immersive learning.
- Career trajectory risk: accepting this position would signal a pivot away from HCI/XR and make future returns to target identity harder.
- Supervisor expertise is in materials engineering, not HCI mentorship; limited support for target identity development.

---
_Generated file — do not edit. Personal notes: create `vault/notes/opp_aalto-doctoral-researcher-phd-student-in-thin-films-for-elec.md` and link [[opp_aalto-doctoral-researcher-phd-student-in-thin-films-for-elec]]._
