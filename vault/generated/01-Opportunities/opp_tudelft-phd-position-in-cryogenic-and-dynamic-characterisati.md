---
id: opp_tudelft-phd-position-in-cryogenic-and-dynamic-characterisati
type: opportunity
title: "PhD Position in Cryogenic and Dynamic Characterisation of Aerospace Materials"
...
**Duration:** not stated
**Status:** open
**Official source:** https://careers.tudelft.nl/job/Delft-PhD-Position-in-Cryogenic-and-Dynamic-Characterisation-of-Aerospace-Materials-2628-CD/1369994757/
...
The project is part of the Dutch Aviation Systems Analysis Lab (DASAL), a collaboration between TU Delft and Royal NLR within the Dutch Luchtvaart in Transitie programme. You will be based in the Optical Metrology for Aerospace (OMA) and Design of Structures research groups within the
Aerospace Structures & Materials (ASM) department
at TU Delft’s
Faculty of Aerospace Engineering
. OMA is a young, interdisciplinary and international research group focusing on optical instrumentation, interferometry and photonics for optical metrology applications.
...
If you would like more information about this vacancy or the selection procedure, please contact Andrei Anisimov, via
a.g.anisimov@tudelft.nl
.
...
In the motivation letter, please describe the main challenges you expect in characterising material deformation and damage under cryogenic conditions using optical measurement techniques.
Please note:
...
PhD position in experimental measurement methods for aerospace materials under cryogenic and dynamic loading, focused on optical metrology techniques to support hydrogen-powered aircraft structures. Part of the DASAL collaboration between TU Delft and Royal NLR.
...
**Missing skills:** optical-metrology, photonics, cryogenic-testing, full-field-optical-methods, image-processing, high-speed-imaging, materials-science, aerospace-engineering

**Risks:**
- Severe disciplinary mismatch: candidate's background is human-centred design and XR; aerospace materials science requires physics/engineering fundamentals not present.
- Complete research pivot: would require abandonment of human-centred XR trajectory and retraining in materials physics.
- No supervisor alignment: Dr. Andrei Anisimov and Dr. Saullo Castro specialize in aerospace materials and optical measurement—not HCI or immersive systems.
- Fundamental conceptual distance: cryogenic material testing has no connection to learning, collaboration, spatial cognition, or immersive design.

---
_Generated file — do not edit. Personal notes: create `vault/notes/opp_tudelft-phd-position-in-cryogenic-and-dynamic-characterisati.md` and link [[opp_tudelft-phd-position-in-cryogenic-and-dynamic-characterisati]]._
