---
id: opp_tudelft-phd-position-scale-up-of-energy-storage-via-sorption
type: opportunity
title: "PhD Position Scale-up of Energy Storage via Sorption-Enhanced CO2 Conversion to Fuel/Chemicals"
...
**Duration:** not stated
**Status:** open
**Official source:** https://careers.tudelft.nl/job/Delft-PhD-Position-Scale-up-of-Energy-Storage-via-Sorption-Enhanced-CO2-Conversion-to-FuelChemicals-2628-CD/1370701857/
...
Are you intrigued by how you can shape the energy transition by scale up of green electricity based large-scale energy storage via CO2 capture and dynamic conversion with hydrogen from electrolysis?
Job description
...
For more information about this vacancy, please contact Prof.dr.ir. Wiebren de Jong,
...
CV
Motivational letter
You can address your application to Prof.dr.ir. Wiebren de Jong.
...
Doctoral position focused on experimental work and reactor engineering for sorption-enhanced CO2 conversion to fuel/chemicals, including scale-up to TRL5 with advanced in-situ measurement techniques and CFD modelling integration.
...
**Risks:**
- Core exclusion: position targets pure chemical/energy engineering process development
- Disciplinary mismatch: Energy systems engineering vs. HCI/multimedia background
- Experimental paradigm incompatible: wet chemistry and process engineering vs. interactive system evaluation
- No transferable domain knowledge or research infrastructure

---
_Generated file — do not edit. Personal notes: create `vault/notes/opp_tudelft-phd-position-scale-up-of-energy-storage-via-sorption.md` and link [[opp_tudelft-phd-position-scale-up-of-energy-storage-via-sorption]]._
