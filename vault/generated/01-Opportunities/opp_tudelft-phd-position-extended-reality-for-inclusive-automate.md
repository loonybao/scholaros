---
id: opp_tudelft-phd-position-extended-reality-for-inclusive-automate
type: opportunity
...
**Duration:** not stated
**Status:** open
**Official source:** https://careers.tudelft.nl/job/Delft-PhD-Position-eXtended-Reality-for-Inclusive-Automated-Vehicle-Interaction-2628-CD/1366984057/
...
_claude-fable-5 · fit_analysis_v1 · confidence 0.88_

4-year PhD in the Mobility in eXtended Reality Lab (Dept. of Transport & Planning, CEG, contact Dr. Yan Feng): use VR/XR to study interactions between automated vehicles and vulnerable road users (incl. people with disabilities), design accessible VR simulators, run VR experiments modelling decision-making, evaluate inclusive external HMIs in real-world tests.
...
**Missing skills:** python, statistics, qualitative-research
