---
id: opp_tudelft-phd-position-control-theory-for-self-designing-digit
type: opportunity
title: "PhD Position Control Theory for Self-Designing Digital Twins of Transportation Systems"
...
**Duration:** not stated
**Status:** open
**Official source:** https://careers.tudelft.nl/job/Delft-PhD-Position-Control-Theory-for-Self-Designing-Digital-Twins-of-Transportation-Systems-2628-CD/1370915557/
...
PhD in formal control theory and autonomous digital twin design for transportation systems at TU Delft's Centre for Systems and Control. Core work involves developing mathematical frameworks for self-configuring digital twins, autonomous controller parametrization, and control policy verification, applied to SUMO-based transportation simulations.
...
**Missing skills:** control-theory, formal-methods, optimization, transportation-systems-modelling

**Risks:**
- Core disciplinary mismatch: control theory and formal methods are not adjacent to HCI or immersive systems research. Retraining would be extensive.
- Supervisor expertise is systems/control, not HCI or XR. Limited mentoring alignment with target identity.
- Position is explicitly excluded by researcher's stated exclusion criteria: focused on formal modelling, control algorithms, and infrastructure systems rather than human-centred design.
- Research outcomes (control stability proofs, MPC verification) do not map to spatial cognition, learning, or collaborative interaction research.

---
_Generated file — do not edit. Personal notes: create `vault/notes/opp_tudelft-phd-position-control-theory-for-self-designing-digit.md` and link [[opp_tudelft-phd-position-control-theory-for-self-designing-digit]]._
