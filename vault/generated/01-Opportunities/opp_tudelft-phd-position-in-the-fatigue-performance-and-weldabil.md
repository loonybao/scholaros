---
id: opp_tudelft-phd-position-in-the-fatigue-performance-and-weldabil
type: opportunity
title: "PhD Position in the Fatigue Performance and Weldability of Next-Generation Structural Steels"
...
**Duration:** not stated
**Status:** open
**Official source:** https://careers.tudelft.nl/job/Delft-PhD-Position-in-the-Fatigue-Performance-and-Weldability-of-Next-Generation-Structural-Steels-2628-CD/1372083657/
...
If you would like more information about this vacancy or the selection procedure, please contact Dr. Florentia Kavoura at
...
TU Delft Faculty of Civil Engineering and Geosciences seeks a PhD researcher to investigate fatigue performance and weldability of next-generation sustainable structural steels (from hydrogen DRI and EAF production). Work combines experimental testing and advanced numerical modelling of base materials and welded joints to assess design method applicability and enable safe infrastructure application.
...
**Missing skills:** python, statistics, mixed-effects-modelling, r

**Risks:**
- Educational background is ineligible by position criteria. Researcher's MSc in multimedia and HCI bears no structural engineering foundation.
- Complete domain expertise gap: materials science, structural mechanics, welding behaviour, FEM modelling—none present in researcher profile.
- Career redirection: three-year commitment would derail human-centred immersive systems trajectory with zero network or methodological transfer.

---
_Generated file — do not edit. Personal notes: create `vault/notes/opp_tudelft-phd-position-in-the-fatigue-performance-and-weldabil.md` and link [[opp_tudelft-phd-position-in-the-fatigue-performance-and-weldabil]]._
