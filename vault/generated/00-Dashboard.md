...
_Generated 2026-07-17 — run `python -m compass export` to refresh._

## Action required (deadlines)

| Opportunity | Organisation | Deadline | Days | Gate | Fit |
|---|---|---|---|---|---|
| [[opp_tampere_project_researcher_hti_2026\|Project Researcher (Human-Technology Interaction), 2-5 positions]] | Tampere University | 2026-08-03 | 17 | uncertain | — |
